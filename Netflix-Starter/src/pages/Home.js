...
const Home = () => {
  ...
  useEffect(() => {
    ...
    async function fetchMyList() {
      ...
      await Moralis.start({ serverUrl: "https://uythnmpu26yi.usemoralis.com:2053/server", appId: "WM3516FibkslU8sq88JiLcngyd2VOshfVXUeSSua"});
  ...
  const handleNewNotification = () => {
    dispatch({
      type: "error",
      message: "Connect your Cripto Wallet",
  ...
  const handleAddNotification = () => {
    dispatch({
      type: "success",
      message: "Movie added to List succesfully",
      title: "Success",
      position: "topL"
    })
  }
  ...
  <div className="topBanner">
    <TabList defaultActiveKey={1} tabStyle="bar">
      <Tab tabKey={1} tabName={"Movies"}>
        <div className='scene'>
          <img src={movies[0].Scene} alt="titanic scene" className="sceneImg"></img>
          <img className='sceneLogo' alt='titanic logo' src={movies[0].Logo}></img>
